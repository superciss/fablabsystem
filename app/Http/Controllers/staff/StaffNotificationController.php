...
class StaffNotificationController extends Controller
{
    ...
    protected function smsNotification($phone, $message)
{
...
public function sendSms(Request $request, Order $order)
{
    ...
    $sent = $this->smsNotification($phone, $message);
    ...
    public function index()
    {
        ...
        return view('staff.notification.index', compact('orders', 'notifications'));
    }
