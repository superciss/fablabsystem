...
<div class="container-fluid px-4" style="margin-left: 20px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
        <div class="d-flex align-items-center gap-3">
            <a href="{{ route('staff.dashboard') }}" class="btn btn-outline-secondary rounded-circle p-2 lh-1 btn-modern">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-sm btn-outline-warning btn-modern" data-bs-toggle="modal" data-bs-target="#editTextureModal{{ $texture->id }}">
                                  ...
                                  <form id="delete-form-{{ $texture->id }}" action="{{ route('texture.destroy', $texture->id) }}" method="POST" class="d-inline-block">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="modal fade" id="editTextureModal{{ $texture->id }}" tabindex="-1" aria-labelledby="editTextureLabel{{ $texture->id }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <form method="POST" action="{{ route('texture.update', $texture->id) }}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
    ...
    <div class="modal fade" id="addTextureModal" tabindex="-1" aria-labelledby="addTextureLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('texture.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
