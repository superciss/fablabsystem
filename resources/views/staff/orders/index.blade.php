...
<div class="container-fluid px-4" style="margin-left: 20px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h2 class="mb-0 text-dark">Orders</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                               ...
                               <form id="delete-form-{{ $order->id }}" action="{{ route('stafforders.destroy', $order->id) }}"  method="POST" class="d-inline-block">
                                        @csrf 
                                        @method('DELETE')
                        ...
                        @include('staff.orders.editorder', ['order'=>$order,'products'=>$products])
                        @endforeach
                    </tbody>
                </table>
            </div>
...
@include('staff.orders.addorder', ['products'=>$products])
@endsection
...
$(function () {
    ...
    $('#bulkActionSelect').on('change', function () {
        ...
        if (action === "delete") {
            ...
            $.post("{{ route('stafforders.bulkDelete') }}", {
                _token: "{{ csrf_token() }}",
                ids: ids
            }, function () {
                location.reload();
            ...
            $.post("{{ route('stafforders.bulkUpdate') }}", {
                _token: "{{ csrf_token() }}",
                ids: ids,
                status: action
            }, function () {
    ...
    $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
        ...
        const cell = table.cell(dataIndex, 7).node();
