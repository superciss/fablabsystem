      ...
      <div class="tab-content" id="texture-tab">
        <div class="control-group">
          ...
          <select id="textureSelect">
            <option value="/image/cspc.png" selected>cspc logo</option>
            <option value="/image/flower.jpg">flower</option>
            <option value="/image/house.png">house</option>
          </select>
          ...
          <button id="addDefaultTexture">Add Default Texture</button>
        </div>
      </div>
...
@push('scripts')
  ...
  <script>
    ...
    function loadDefaultModel() {
      // This would normally load from your server path
      // For demonstration, we'll create a simple placeholder
      if (currentModel) scene.remove(currentModel);
      
      // Create a simple t-shirt geometry as a placeholder
      ...
      // In a real implementation, you would load from your server:
...
document.getElementById('addStar').onclick = () => {
  ...
  fabricCanvas.add(star).setActiveObject(star);
    ...
    window.addEventListener('resize', () => {
     ...
     // Add event listener for the default texture button
  document.getElementById('addDefaultTexture').addEventListener('click', addDefaultTextureToCanvas);

  // Function to add default texture to fabric canvas
  function addDefaultTextureToCanvas() {
    // Get the selected texture URL from the dropdown
    const textureUrl = document.getElementById('textureSelect').value;
    ...
    img.onload = function() {
      ...
      fabric.Image.fromURL(textureUrl, function(fabricImg) {
        ...
        // Add to canvas and set as active
    ...
    img.onerror = function() {
      console.error("Error loading default texture:", textureUrl);
      alert("Could not load the default texture. Please check the file path.");
    };
    img.src = textureUrl;
  }

  // Also add functionality to load default texture when selection changes
  document.getElementById('textureSelect').addEventListener('change', function() {
    // Optionally auto-add the selected texture
    // addDefaultTextureToCanvas();
  });
