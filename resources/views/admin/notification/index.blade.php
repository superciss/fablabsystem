                        ...
                        @forelse($orders as $order)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('notification.send', $order->id) }}" method="POST">
                                        @csrf
                                        <button type="submit" 
                                 ...
                                 <td>
                                    <form action="{{ route('orders.sendSms', $order->id) }}" method="POST">
                                        @csrf
...
$(function () {
    ...
    $('#bulkActionSelect').on('change', function () {
        ...
        if (action === "delete") {
            ...
            $.post("{{ route('notification.bulkDelete') }}", {
                _token: "{{ csrf_token() }}",
                ids: ids
            })
            ...
            $.post("{{ route('notification.bulkSend') }}", {
                _token: "{{ csrf_token() }}",
                ids: ids
            })
            .done(function(response) {
