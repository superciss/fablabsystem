...
<div class="container-fluid px-4" style="margin-left: 20px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
        <div>
            <h2 class="dashboard-title">Products Management</h2>
            <p class="dashboard-subtitle">Manage your products, stock levels, and categories</p>
        </div>
        <div class="d-flex gap-3">
            <button class="btn btn-primary btn-modern d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#addProductModal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-sm btn-outline-warning btn-modern" data-bs-toggle="modal" data-bs-target="#editProductModal{{ $product->id }}">
                        ...
                        @include('admin.products.editproduct', ['product' => $product, 'categories' => $categories])
                        @empty
                        <tr>
...
@include('admin.products.addproduct', ['categories' => $categories])
@endsection
