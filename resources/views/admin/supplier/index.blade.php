...
<style>
    ...
    /* Link styling */
    a.text-primary { color: #3b82f6; }
    a.text-primary:hover { color: #2563eb; }
...
<div class="container-fluid px-4" style="margin-left: 20px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
        <div class="d-flex align-items-center gap-4">
            ...
            <div>
                <h2 class="dashboard-title">Suppliers Management</h2>
                <p class="dashboard-subtitle">Streamline supplier information</p>
            </div>
        </div>
        <button class="btn btn-primary btn-modern d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#addSupplierModal">
    ...
    <div class="row mb-4">
            ...
            <div class="modern-card" tabindex="0">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="stat-value text-primary">{{ $suppliers->count() }}</h4>
                    </div>
            ...
            <div class="modern-card" tabindex="0">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="stat-value text-success">{{ $suppliers->count() }}</h4>
                    </div>
            ...
            <div class="modern-card" tabindex="0">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="stat-value text-warning">2</h4>
                    </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="modern-card" tabindex="0">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <div class="card-header">Avg. Contacts</div>
                        <h4 class="stat-value text-info">3.2</h4>
                    </div>
    ...
    <div class="modern-table">
        ...
        <div class="card-body p-2">
            <div class="table-responsive">
                <table class="table table-sm align-middle" id="suppliersTable" style="width:100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Supplier</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($supplier->phone)
                                    <a href="tel:{{ $supplier->phone }}" class="text-decoration-none text-primary">
                                        {{ $supplier->phone }}
                                    </a>
                                @else
                                    N/A
                            ...
                            <td>{{ Str::limit($supplier->address ?? 'N/A', 25) }}</td>
                            <td class="text-center">
                                <button class="btn btn-sm btn-outline-warning btn-modern" data-bs-toggle="modal" data-bs-target="#editSupplierModal{{ $supplier->id }}">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                                <form id="delete-form-{{ $supplier->id }}" action="{{ route('suppliers.destroy', $supplier->id) }}" method="POST" class="d-inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-sm btn-outline-danger btn-modern" onclick="confirmDelete('delete-form-{{ $supplier->id }}')">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </form>
                            </td>
                        </tr>
                        @include('admin.supplier.editsupplier', ['supplier' => $supplier])
                        @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted" style="padding: 2rem;">No suppliers found</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <!-- Add Modal -->
    @include('admin.supplier.addsupplier')
</div>
@endsection
